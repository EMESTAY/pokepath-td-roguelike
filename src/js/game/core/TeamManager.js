...
export class TeamManager {
  constructor(main, data) {
    ...
    this.teamA = Array.isArray(data['teamA'])
      ? data['teamA']
      : [[], [], [], [], [], [], [], [], []];
    this.teamB = Array.isArray(data['teamB'])
      ? data['teamB']
      : [[], [], [], [], [], [], [], [], []];
    this.teamC = Array.isArray(data['teamC'])
      ? data['teamC']
      : [[], [], [], [], [], [], [], [], []];
    this.teamD = Array.isArray(data['teamD'])
      ? data['teamD']
      : [[], [], [], [], [], [], [], [], []];
    this.teamE = Array.isArray(data['teamE'])
      ? data['teamE']
      : [[], [], [], [], [], [], [], [], []];
    ...
    if (!challenge) {
      this.teams[slot][this.main.area.routeNumber].forEach((pokemon, i) => {
        ...
        if (pokemon.tilePosition != -1) {
          ...
          this.main.UI.tilesCountNum[
            this.main.area.placementTiles[pokemon.tilePosition].land - 1
          ]++;

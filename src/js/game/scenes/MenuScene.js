...
export class MenuScene extends GameScene {
  ...
  getConfig() {
    return this.main.dataManager.config;
  }

  saveConfig(newConfig) {
    this.main.dataManager.data.config = newConfig;
  ...
  update() {
    ...
    this.autoStopBossRow.label.innerText =
      text.menu.settings.autoStopBoss[this.main.lang].toUpperCase();
    this.autoStopBossRow.value.innerText = data.config.autoStopBoss
      ? text.ui.yes[this.main.lang].toUpperCase()
      : text.ui.no[this.main.lang].toUpperCase();
  ...
  updateAutoReset = (dir) => {
    ...
    this.main.dataManager.config.autoReset = this.main.autoReset;
    this.main.dataManager.persist();
  ...
  updateDisplayHealth = (dir) => {
    ...
    this.main.dataManager.config.displayHealth = this.main.displayHealth;
    this.main.dataManager.persist();
  ...
  updateAutoStop = () => {
    ...
    this.main.dataManager.config.autoStop = this.main.autoStop;
    this.main.dataManager.persist();
  ...
  updateAutoStopBoss = () => {
    ...
    this.main.dataManager.config.autoStopBoss = this.main.autoStopBoss;
    this.main.dataManager.persist();
  ...
  updateShowDamage = () => {
    ...
    this.main.dataManager.config.showDamage = this.main.showDamage;
    this.main.dataManager.persist();
  ...
  render() {
    ...
    this.importButton.addEventListener("click", () => {
      ...
      if (this.newData != null) {
        ...
        this.main.dataManager.data.save = {
          new: false,

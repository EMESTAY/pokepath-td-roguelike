export const itemData = {
  ...
  shieldBreakerBullet: {
    ...
    name: [
      'Shield Breaker Bullet',
      'Bala Rompeescudos',
      'Balle Perçante',
      'Projétil Quebrador de Escudo',
      'Proiettile Spaccascudo',
      'Schildbrecher-Kugel',
      'シールドブレイカーバレット',
      '실드 브레이커 탄환',
      '破盾子彈',
  ...
  razorClaw: {
    ...
    restriction: {
      idForbidden: [
        0, 5, 6, 9, 10, 13, 14, 15, 16, 19, 20, 25, 28, 34, 42, 49, 51, 52, 54, 55, 56, 60, 64, 69,
        70, 72, 80, 83, 86,
      ],
    },
  },
  ...
  zoomLens: {
    ...
    restriction: {
      idForbidden: [
        13, 14, 19, 24, 26, 33, 37, 41, 42, 44, 47, 49, 51, 52, 53, 56, 58, 59, 64, 65, 67, 70, 74,
        75, 80, 83, 85,
      ],
    },
  },
  ...
  spindaCocktail: {
    ...
    restriction: {
      idForbidden: [
        13, 14, 24, 26, 33, 37, 41, 42, 44, 47, 49, 51, 52, 53, 56, 58, 59, 64, 65, 67, 70, 74, 80,
        85, 19, 83,
      ],
    },
  },

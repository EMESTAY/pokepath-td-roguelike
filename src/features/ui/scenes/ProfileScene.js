...
import { achievementData } from '../../../data/static/achievementData.js';
  ...
  update() {
    ...
    this.stats[19].value.innerText =
      this.main.player.stats.maxGoldPerWave[1] == null
        ? `$0`
        : `(${this.main.player.stats.maxGoldPerWave[1]}) $${this.main.utility.numberDot(
    ...
    this.stats[20].value.innerText =
      this.main.player.stats.maxGoldPerTime[1] == null
        ? `$0/s`
        : `(${this.main.player.stats.maxGoldPerTime[1]}) $${this.main.utility.numberDot(

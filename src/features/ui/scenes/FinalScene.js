...
import { enemyData } from '../../../data/static/enemyData.js';
...
export class FinalScene extends GameScene {
  ...
  render() {
    ...
    this.challengeContainer = new Element(this.container, {
      className: 'final-challenge-container',
    }).element;
    this.challenge = [];
  }
  ...
  update() {
    ...
    if (this.main.area.inChallenge) {
      ...
      this.main.area.inChallenge.forEach((chall, i) => {
        this.challenge[i] = new Element(this.challengeContainer, {

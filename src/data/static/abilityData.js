export const abilityData = {
  ...
  curseDoubleShot: {
    ...
    name: [
      'Curse DoubleShot',
      'Disparo Doble Maldito',
      'Double Tir Maudit',
      'Disparo Duplo Amaldiçoado',
      'Doppio Colpo Maledetto',
      'Fluch-Doppelschuss',
      'カースダブルショット',
      '커스 더블샷',
      '詛咒雙重射擊',
  ...
  armorBreakDoubleShot: {
    ...
    name: [
      'Armor Break DoubleShot',
      'Disparo Doble Rompearmadura',
      'Double Tir Brise-Armure',
      'Disparo Duplo Quebra-Armadura',
      'Doppio Colpo Rompicolpo',
      'Doppelschuss Rüstungsbrecher',
      'アーマーブレイクダブルショット',
      '방어력파괴 더블샷',
    ],
    description: [
